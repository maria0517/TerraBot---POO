...
public final class Ferns extends Plant {
    private static final double ATTACKPROB = 30;
    private static final double OXIGENFROMPLANT = 0.0;

    public Ferns(final String type, final String name, final double mass, final String status) {
